...
def create_from_ocel(c,base,connect,type):
    ...
    if type == 'ocel':
        ...
        o1m.create_eventType_Oced(c,connect)
        o1m.create_event_Oced(c,connect)
        o1m.create_objectObject_Oced(c,connect)
        o1m.create_eventObject_Oced(c,connect)
        o1m.create_objectType_Oced(c,connect)
        o1m.create_object_Oced(c,connect)
        o1m.create_objectRelationEvent_Oced(c,connect)
        o1m.create_objectAttribute_Oced(c,connect)
        o1m.create_objectAttributeValue_Oced(c,connect)
        o1m.create_objectAttributeValueEvent_Oced(c,connect)
        o1m.create_eventAttribute_Oced(c,connect)
        o1m.create_eventAttributeValue_Ocel(c,connect)
def main():
